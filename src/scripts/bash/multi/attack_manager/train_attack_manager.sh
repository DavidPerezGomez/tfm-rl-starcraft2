...
MAP=DefeatBases
TRAIN_EPISODES=800 # ~50 steps/episode ~40000 steps
LEARNING_RATE_MILESTONES="480,640,720"
LEARNING_RATE=0.001
GAMMA=0.95
...
EPSILON=0.99
EPSILON_DECAY=0.993 # ~640 steps until minimum
MIN_EPSILON=0.01

DQN_SIZE="medium" # extra_small, small, medium, large, extra_large
MEMORY_SIZE=10000
BURN_IN=1000 # ~20 episodes
BATCH_SIZE=512
