...
TRAIN_EPISODES=85 # 300 steps/episode ~25000 steps
LEARNING_RATE_MILESTONES="" # "51,68"
LEARNING_RATE=0.002
GAMMA=0.99
...
TARGET_NETWORK_UPDATE_TAU=0.2 # if soft
